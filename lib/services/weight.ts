 ...
 *
 * - Capacitor 原生：直接调用 lib/db 模块（route 复用本模块 groupByPerson）
...
/** 按 person 分组（route 与 Capacitor 分支共用）。 */
export function groupByPerson(logs: WeightLog[]): { me: WeightLog[]; her: WeightLog[] } {
